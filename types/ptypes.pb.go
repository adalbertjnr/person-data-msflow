...
func (x *AggregatePerson) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AggregatePerson) ProtoMessage() {}

func (x *AggregatePerson) ProtoReflect() protoreflect.Message {
	mi := &file_types_ptypes_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use AggregatePerson.ProtoReflect.Descriptor instead.
func (*AggregatePerson) Descriptor() ([]byte, []int) {
	return file_types_ptypes_proto_rawDescGZIP(), []int{1}
}

func (x *AggregatePerson) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *AggregatePerson) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *AggregatePerson) GetAge() int32 {
	if x != nil {
		return x.Age
	}
	return 0
...
func (x *AggregatePerson) GetRole() string {
	if x != nil {
		return x.Role
	}
	return ""
...
func (x *AggregatePerson) GetStage() string {
	if x != nil {
		return x.Stage
	}
	return ""
...
var file_types_ptypes_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0x06, 0x0a, 0x04, 0x4e,
	0x6f, 0x6e, 0x65, 0x22, 0x71, 0x0a, 0x0f, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65,
	...
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x12, 0x0a, 0x04,
	...
	0x05, 0x73, 0x74, 0x61, 0x67, 0x65, 0x32, 0x40, 0x0a, 0x0a, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67,
	0x61, 0x74, 0x6f, 0x72, 0x12, 0x32, 0x0a, 0x09, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74,
	0x65, 0x12, 0x16, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67,
	0x61, 0x74, 0x65, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x1a, 0x0b, 0x2e, 0x74, 0x79, 0x70, 0x65,
	0x73, 0x2e, 0x4e, 0x6f, 0x6e, 0x65, 0x22, 0x00, 0x42, 0x1e, 0x5a, 0x1c, 0x67, 0x69, 0x74, 0x68,
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x61, 0x64, 0x61, 0x6c, 0x62, 0x65, 0x72, 0x74, 0x6a,
	0x6e, 0x72, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_types_ptypes_proto_goTypes = []interface{}{
	(*None)(nil),            // 0: types.None
	(*AggregatePerson)(nil), // 1: types.AggregatePerson
}
var file_types_ptypes_proto_depIdxs = []int32{
	1, // 0: types.Aggregator.Aggregate:input_type -> types.AggregatePerson
	0, // 1: types.Aggregator.Aggregate:output_type -> types.None
