...
type AggregatorClient interface {
	Aggregate(ctx context.Context, in *AggregatePerson, opts ...grpc.CallOption) (*None, error)
}
...
func (c *aggregatorClient) Aggregate(ctx context.Context, in *AggregatePerson, opts ...grpc.CallOption) (*None, error) {
	out := new(None)
	err := c.cc.Invoke(ctx, "/types.Aggregator/Aggregate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AggregatorServer interface {
	Aggregate(context.Context, *AggregatePerson) (*None, error)
...
func (UnimplementedAggregatorServer) Aggregate(context.Context, *AggregatePerson) (*None, error) {
...
func _Aggregator_Aggregate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/types.Aggregator/Aggregate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).Aggregate(ctx, req.(*AggregatePerson))
	}
